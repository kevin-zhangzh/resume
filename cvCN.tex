...
\section{实习经历}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Startup, \href{https://www.ever.finance}{\underline{everVision}}(区块链存储相关)}{May 2022 -- Mar 2023}
      {golang 后端开发}{杭州, 浙江}
      \resumeItemListStart
        ...
        \resumeItem{参与维护多个公司主导的开源项目，整理撰写多个生态相关的开源项目文档，开发并维护文档站点 \href{https://web3infra.dev/}{\underline{web3infra}}}
      \resumeItemListEnd
...
%            \resumeItem{支持 http 206 content-range，实现二进制类型文件的断点续传}
          ...
          \resumeItemListStart
            ...
            \resumeItem{通过 ECC 非对称加密传递会话密钥，后续通过 AES 对称加密使用会话密钥对通讯进行加密，目的是防止网络传输中,转账地址被替换的风险}
...
% \end{itemize}
    \resumeItemListStart
    \resumeItem{熟悉 golang 的基本语法和相关特性，以及 web 开发框架及流程，熟悉多人协作开发流程，熟悉 devops 流程}
    \resumeItem{具备扎实的计算机基础，熟悉常见的数据结构与算法，熟悉常见的计算机网络通信协议，喜欢在开源生态做贡献，追求高质量的代码}
    \resumeItem{了解 C++，java，python 等流行编程语言，了解基本的 linux 操作}
    \resumeItem{了解云原生及分布式相关的内容，docker， k8s，zk，grpc，数据一致性的维护，喜欢阅读源码（etcd,grpc,k8s,ethereum）等}
...
%    \resumeItem{掌握 opensea 的接口调用并利用其进行二次开发}
    \resumeItem{喜欢思考，乐于接受挑战，具备解决问题的能力，有较强的学习能力，英文阅读能力，代码阅读能力，能快速上手投入实际项目的开发}
    \resumeItemListEnd
 \vspace{-16pt}
